...
const translations = {
  en: {
    ...
    auth_password_hint: "Use at least 10 characters with uppercase, lowercase, numbers, and symbols.",
    auth_password_generate: "Suggest Strong Password",
    auth_password_strength_empty: "A stronger password is safer for your partner account.",
    auth_password_strength_weak: "Too weak. Add more character variety.",
    auth_password_strength_medium: "Good start. Add one more character type for better security.",
    auth_password_strength_strong: "Strong password.",
    ...
    auth_reset_send_button: "Send",
    auth_reset_close: "Cancel",
  ...
  ko: {
    ...
    auth_password_show: "보기",
    auth_password_hide: "숨기기",
    auth_password_hint: "영문 대문자, 소문자, 숫자, 특수문자를 포함해 10자 이상으로 설정해 주세요.",
    auth_password_generate: "강력한 비밀번호 추천",
    auth_password_strength_empty: "파트너 계정을 위해 더 안전한 비밀번호를 사용해 주세요.",
    auth_password_strength_weak: "보안이 약합니다. 문자 종류를 더 섞어 주세요.",
    auth_password_strength_medium: "좋습니다. 문자 종류를 하나 더 추가하면 더 안전합니다.",
    auth_password_strength_strong: "강력한 비밀번호입니다.",
